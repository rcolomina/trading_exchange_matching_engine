...
from order import SideOrder, Order
...
def find_trader_for_order(order: Order, traders) -> Trader:
...
def send_limit_order_and_update_trader(order, market: Market, traders) -> bool:
